...
<script src="asset/bootstrap-show-password.min.js"></script>
...
<!-- /show password -->
<body class="font-medium" style="background-color:#eceff1;">
...
<div class="group">
  ...
  <div class="right" style="background-color:white;font-family: GillSans, Calibri, Trebuchet, sans-serif;color:black;">
		<table width="100%" border="0" style="margin-top:10px">
   		<tr><td rowspan="3" width="120px" align="center"><img src="images/nouser.png" style="margin-left:0px;border:3px solid #cfd8dc;" class="foto"></td>
					<td>Selamat Datang di Aplikasi CBT <br> <b><?php echo $skull; ?></b></td></tr>
			<tr><td><span class="user" style="color:#01579b;">Siswa Peserta CBT</span></td></tr>
			<tr><td><span class="log"><a href="logout.php" style="color:grey;"><u>Keluar</u></a><span></td></tr>
		</table>
  </div>
</div>
...
<div class="panel panel-default" style="margin-top:20px">
	<div class="panel-heading " style="font-size:30px; font-weight:bold; padding-left:20px;font-family: GillSans, Calibri, Trebuchet, sans-serif;">
		<!-- <img src="images/<?php echo  $logo  ?>" style=" width:17%; margin-top:-5px; overflow:hidden "/> -->
		<img src="images/tutwurihandayani.png" style=" width:17%; margin-top:-5px; overflow:hidden; "/>
		&nbsp&nbsp Login Peserta Ujian
    </div>
					...
					<div class="col-sm-8 input-wrapper">
						<span class="glyphicon glyphicon-user" aria-hidden="true"></span>
							<input class="form-control" style="width:87%; height:37px; margin-left:38px" data-val="true" data-val-required="User name wajib diisi"
								id="inputUsername" name="UserName" placeholder="Ketik nomor induk" type="text" value="">
						...
						<div class="col-sm-8 input-wrapper">
							...
							<span class="glyphicon glyphicon-eye-open showPassword" aria-hidden="true">&nbsp;&nbsp;</span>
								<input class="form-control" style="width:87%; height:37px; margin-left:38px"  data-val="true" data-val-required="Password wajib diisi"
									id="inputPassword" name="Password" placeholder="Ketik nomor induk" type="password" value="">
							<br>
						</div>
				</div>
				<div class="form-group">
					<div class="col-sm-offset-3 col-sm-8 text-right">
						<button type="submit" class="btn btn-success btn-block doblockui" onClick="validateAndSend()" style="background-color:#01579b;">MASUK</button>
					</div>
				</div>
			</div>
		</form>
...
<footer>
	...
	<div class="group" style="background-color:white;">
	  <!-- <div  style="background-color:<?php echo $warna; ?>; padding:7px; font-size:12px"> -->
		<div  style="background-color:white;padding:7px; font-size:12px">
	      <p><span style="color: #01579b;font-family: GillSans, Calibri, Trebuchet, sans-serif;font-size:14px;"><b><?php echo strtoupper($skull); ?></b> </span><br> <span style="color: #607d8b;font-family: GillSans, Calibri, Trebuchet, sans-serif;">Modified by <b>ARTHAPATRIA</b></span>></p>
	  </div>
	</div>
</footer>
