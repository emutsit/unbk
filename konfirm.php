...
<header style="background-color:<?php echo "$r[XWarna]"; ?> ; ">
	<div class="group">
		<div class="left" style="background-color:white;">
			...
			<span style="font-size:30px;color:#01579b;font-family: GillSans, Calibri, Trebuchet, sans-serif;line-height:16px;"><b>Sistem Informasi Ujian Nasional Berbasis Komputer (CBT)</b></span>
		</div>
	  <div class="right" style="background-color:white;font-family: GillSans, Calibri, Trebuchet, sans-serif;color:black;">
			<table width="100%" border="0" style="margin-top:10px">
	   		<tr><td rowspan="3" width="120px" align="center"><img src="fotosiswa/<?php echo "$gambar"; ?>" style="margin-left:0px;border:3px solid #cfd8dc;" class="foto"></td>
				...
				<tr><td>
					<span class="user" style="color:#01579b;"><?php echo "$val_siswa <br>($xkelz-$xjurz)"; ?></span>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<span class="log text-right"><a href="logout.php" style="color:red;"><u>Logout</u></a><span>
				</td></tr>
			</table>
	  </div>
	</div>
                    ...
                    <div class="inner-content">
                        <div class="wysiwyg-content">
                            <p>
                                ...
                                Silahkan klik tombol keluar untuk mengakhiri test.                            </p>
                        </div>
                    </div>
                </div>
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-xs-offset-3 col-xs-6">
                            <button type="submit" class="btn btn-success btn-block" data-dismiss="modal">Keluar</button>
                        </div>
                    </div>
                </div>
            </div>
...
<footer>
    <div style="width:98%; margin:0px 15px 15px 15px; height:60px; background-color:#fffefb;border-bottom-color:#e4e4e2; font-size:14px; padding:15px; text-align:center">
      <span style="color: #01579b;font-family: GillSans, Calibri, Trebuchet, sans-serif;">
      <b><?php echo strtoupper($skull); ?></b> </span>| <span style="color: #607d8b;font-family: GillSans, Calibri, Trebuchet, sans-serif;">Modified by <b>ARTHAPATRIA</b>
      </span>
    </div>
</footer>
