...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link href='images/tutwurihandayani.png' rel='icon' type='image/png'/>
<style>
...
$hit = 1;
  ...
  while($r2=mysql_fetch_array($sqlambilsoalpilT1)){
	...
	$sql = mysql_query("insert into cbt_jawaban (Urut,XNomerSoal,XUserJawab,XKodeSoal,XTokenUjian,XA,XB,XC,XTglJawab,XJenisSoal,XKodeKelas,XKodeJurusan,XKodeUjian,XSetId,XKodeMapel,XSemester) values
	('$hit','$r2[XNomerSoal]','$user','$xkodesoal','$xtokenujian','$A1','$B1','$C1','$tglbuat','1','$xkodekelasx','$xkodejurusx','$xkodeujianx',
'$xsetidx','$xkodemapel','$xsemester')");
	...
	$sql = mysql_query("insert into cbt_jawaban (Urut,XNomerSoal,XUserJawab,XKodeSoal,XTokenUjian,XA,XB,XC,XD,XTglJawab,XJenisSoal,XKodeKelas,XKodeJurusan,XKodeUjian,XSetId,XKodeMapel,XSemester) values
	('$hit','$r2[XNomerSoal]','$user','$xkodesoal','$xtokenujian',
...
'$xsetidx','$xkodemapel','$xsemester')");
	...
	$sql = mysql_query("insert into cbt_jawaban (Urut,XNomerSoal,XUserJawab,XKodeSoal,XTokenUjian,XA,XB,XC,XD,XE,XTglJawab,XJenisSoal,XKodeKelas,XKodeJurusan,XKodeUjian,XSetId,XKodeMapel,XSemester) values
	('$hit','$r2[XNomerSoal]','$user','$xkodesoal','$xtokenujian','$A1','$B1','$C1','$D1','$E1','$tglbuat','1','$xkodekelasx','$xkodejurusx','$xkodeujianx',
'$xsetidx','$xkodemapel','$xsemester')");
	$hit = $hit+1;
	}
...
'$xsetidx','$xkodemapel','$xsemester')");
	...
	$D1 = $a[3];
	$sql = mysql_query("insert into cbt_jawaban (Urut,XNomerSoal,XUserJawab,XKodeSoal,XTokenUjian,XA,XB,XC,XD,XTglJawab,XJenisSoal,XKodeKelas,XKodeJurusan,XKodeUjian,XSetId,XKodeMapel,XSemester) values
	('$hit','$r2[XNomerSoal]','$user','$xkodesoal','$xtokenujian','$A1','$B1','$C1','$D1','$tglbuat','1','$xkodekelasx','$xkodejurusx','$xkodeujianx',
'$xsetidx','$xkodemapel','$xsemester')");
	$hit = $hit+1;
	}
	elseif($xjumlahpilihan==5){
...
<header background-color:"<?php echo "$log[XWarna]"; ?>">
	<div class="group">
		<div class="left" style="background-color:white;">
			<img src="images/tutwurihandayani.png" style=" margin-left:20px;" width="10%"><?php	echo "&nbsp;&nbsp;&nbsp;&nbsp;";?>
			<span style="font-size:30px;color:#01579b;font-family: GillSans, Calibri, Trebuchet, sans-serif;"><b>Sistem Informasi Ujian Nasional Berbasis Komputer (CBT)</b></span>
		</div>
	  <div class="right" style="background-color:white;font-family: GillSans, Calibri, Trebuchet, sans-serif;color:black;">
			<table width="100%" border="0" style="margin-top:10px">
	   		<tr><td rowspan="3" width="120px" align="center"><img src="fotosiswa/<?php echo "$gambar"; ?>" style="margin-left:0px;border:3px solid #cfd8dc;" class="foto"></td>
						<td>Selamat Datang di Aplikasi CBT <br> <b><?php echo $skull; ?></b></td></tr>
				<tr>
					...
					<tr><td><span class="user">Jangan Lupa Do'a</span></td>
				</tr>
			</table>
	  </div>
	</div>
	<!-- <div class="group" style="background-color:<?php echo "$log[XWarna]"; ?>">
		<div class="left" style="background-color:<?php echo "$log[XWarna]"; ?>">
			<img src="images/<?php echo "$log[XBanner]"; ?>" style=" margin-left:0px;">
		</div>
			<div class="right1">
				<table width="120%" border="0" cellspacing="5px;" style="margin-top:10px">
					<tr><td rowspan="3" width="120px" align="center"><img src="fotosiswa/<?php echo "$gambar"; ?>" style=" margin-left:0px; margin-top:5px;" class="foto"></td></tr>
					<td><span  class="user" style=" margin-left:0px; margin-top:5px">Selamat Mengerjakan</span></td></tr>
					<tr><td><span class="user"><?php echo "$val_siswa ($kodekelas-$kodejurusan)"; ?></span></td></tr>
                ...
                <div class="panel-body">
                    <div class="inner-content">
                        <div class="wysiwyg-content">
                            <p>
                                Terimakasih telah berpartisipasi dalam tes ini.<br>
                                Silahkan klik tombol Keluar untuk mengakhiri test.
                            </p>
                        </div>
                    </div>
                </div>
